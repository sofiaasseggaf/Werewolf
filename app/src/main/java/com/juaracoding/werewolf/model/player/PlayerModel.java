...
public class PlayerModel implements Serializable, Parcelable
{
    ...
    public final static Creator<PlayerModel> CREATOR = new Creator<PlayerModel>() {
    ...
    ;
    private final static long serialVersionUID = 963108505196692208L;
