...
public class SkillModel implements Serializable, Parcelable
{
    ...
    public final static Creator<SkillModel> CREATOR = new Creator<SkillModel>() {
    ...
    ;
    private final static long serialVersionUID = -4600593501561762032L;
